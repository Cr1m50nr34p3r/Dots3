...
function round_rect_bar(cr, width, height)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({position = "top", screen = s , height = 50, shape = round_rect_bar})
...
globalkeys = my_table.join(
    ...
    -- Shutdown
    awful.key({modkey,'Mod1'}, 's',function () awful.spawn.with_shell( "shutdown now") end,
        {description = "Shutdown", group = "Awesome"}),
    
    -- reboot
    awful.key({modkey,'Mod1'}, 'r',function () awful.spawn.with_shell( "reboot") end,
        {description = "reboot", group = "Awesome"}),
    

    -- maim
    awful.key({},'Print', function () awful.spawn.with_shell( "maim --select | tee ~/Media/Pictures/Screenshots/$(date +%s).png | xclip -select clipboard -t image/png") end,
        {description = "Screen shot selected area", group = "Utilities"}),
    ...
    awful.key({ modkey ,'Mod1'}, "e", function () awful.util.spawn( "emacs" ) end,
        {description = "doom emacs", group = "apps"}),
    ...
    awful.key({ modkey }, "c", function () awful.spawn.with_shell( "brave-browser classroom.google.com/u/1/h" ) end,
 ...
 -- Show/Hide Systray
   ...
   -- awful.key({ }, "XF86AudioMute",
    ...
    awful.key({ }, "XF86AudioRaiseVolume", function ()
       awful.spawn.with_shell("amixer set Master 10%+") end),
...
---  AUTO START APPS ---
------------------------
awful.spawn.with_shell("~/.config/awesome/auto-start.sh")
